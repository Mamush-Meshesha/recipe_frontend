        ...
        >
          <div class="flex flex-col gap-4 md:gap-8 dark:text-white">
            ...
            <p class="md:w-[300px] w-full">
              ...
              doloribus molestiae veritatis! Officia, repellat dolores autem
              voluptates laudantium? Obcaecati porro
            </p>
          </div>
          <!-- testibite -->
          <div
          ...
          >
            <div>
              ...
              <div class="md:flex md:flex-col hidden">
                ...
                <NuxtLink to="/">conditions</NuxtLink>
                <NuxtLink to="/">cookies</NuxtLink>
                <NuxtLink to="/">copyright</NuxtLink>
              </div>
            </div>
            <div class="block md:hidden">
              <svg
